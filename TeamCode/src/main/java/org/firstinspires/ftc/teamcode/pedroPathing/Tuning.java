 ...
 */
@Configurable
@TeleOp(name = "Tuning v5", group = "Pedro Pathing")
public class Tuning extends SelectableOpMode {
    ...
    //static double averageVelocity = 0;
    //static double targetVelocity = VELOCITY;
    public Tuning() {
...
class ForwardVelocityTuner extends OpMode {
    ...
    public void init_loop() {
        ...
        //telemetryM.debug("distance = ", follower.getDistanceRemaining());
        telemetryM.update(telemetry);
...
class ForwardZeroPowerAccelerationTuner extends OpMode {
    ...
    public void init_loop() {
        ...
        telemetryM.addData("average Velocity", average);
        telemetryM.addData("target Velocity", VELOCITY);
        telemetryM.update(telemetry);
        follower.update();
        drawCurrent();
    }
    ...
    public void loop() {
        ...
        telemetryM.addData("current Velocity", follower.getVelocity().dot(heading));
        ...
        if (!end) {
            if (!stopping) {
                ...
                currentVelocity = follower.getVelocity().dot(heading);
...
class HeadingTuner extends OpMode {
    ...
    public void loop() {
        ...
        telemetryM.debug(String.format("getHeadingGoal: %.2f", follower.getHeadingGoal(0.0)));
        telemetryM.debug(String.format("getHeading: %.2f", follower.getHeading()));
        telemetryM.debug(String.format("getHeadingError: %.2f", follower.getHeadingError()));
